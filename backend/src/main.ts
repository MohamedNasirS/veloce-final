...
async function bootstrap() {
  ...
  app.useStaticAssets(path.resolve(__dirname, '..', 'uploads'), {
    prefix: '/uploads', // will map to http://147.93.27.172/uploads
  });
  ...
  console.log(`✅ Server running at http://147.93.27.172`);
  console.log(`🔗 Swagger: http://147.93.27.172/api`);
  console.log(`📁 Static files served from http://147.93.27.172/uploads/...`);
}
