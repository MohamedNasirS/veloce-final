Write-Host "Starting local application with Prisma Console on port 3002..." -ForegroundColor Green
...
Write-Host "Environment configured for Prisma Console!" -ForegroundColor Green
Write-Host "Starting application in development mode..." -ForegroundColor Cyan
Write-Host "Application will be available at: http://localhost:3002" -ForegroundColor Yellow
